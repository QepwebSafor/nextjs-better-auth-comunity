...
export default async function Page() {
  ...
  return (
    <div className="px-8 py-6 container mx-auto max-w-screen-lg space-y-4">
      ...
      <div className="space-x-4">
        <Button size="sm"> <Link href="/articles"> ARTICULOS </Link></Button>
        
          <Button size="sm" >
          <Link href="/dashboard/articles/create">CREAR ARTICULOS</Link>
        </Button>
        <Button size="sm" disabled={!FULL_POST_ACCESS.success}>
          <Link href="/dashboard/articles">MANEJAR TODOS LOS ARTICULOS</Link>
        </Button>
